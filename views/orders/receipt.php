                                    ...
                                    <table border="0" width="100%" cellpadding="3" >
                                           <tr><td >
                                                <table border="0" align="center" bgcolor="#99ccff">
													<tr><td> 
    <?php if (count($template->orders) > 1): ?>
      <form method="POST" action="add">
        <table>
          <tr><td>
              <Table>
                <?php foreach ($template->orders as $user): ?>
                  <?php if ($user->customer == "1"): ?>
                    <tr><td><?php echo $user->timestamp; ?></td></tr>
                    <tr><td>
                        Graphic Card: <?php echo $user->graphics; ?><br/>
                        Hard Drive: <?php echo $user->harddisk; ?><br/>
                        Monitor: <?php echo $user->monitor; ?><br/>
                        Processor: <?php echo $user->processor; ?><br/>
                        RAM: <?php echo $user->ram; ?><br/>
                        Optical Rom: <?php echo $user->optical_rom; ?><br/>
      ...
      <?php elseif (count($template->orders) == 1): ?>
        <ul>
          <li>
            <a href="users/<?php echo $template->orders->user_id; ?>"><?php echo $template->orders->type; ?> </a> |
            <a href="users/<?php echo $template->orders->user_id; ?>/edit">Edit</a>
          </li>
        </ul>
      <?php else: ?>
