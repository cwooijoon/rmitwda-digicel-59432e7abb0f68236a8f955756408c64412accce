<?php
// This is the index page for order
// available vars:
...
<html>
    ...
    <body bgcolor="#ffffff">
                                    ...
                                    <table border="0" width="100%" cellpadding="3" >
                                           <tr><td >
                                                <table border="0" align="center" bgcolor="#99ccff">
													<tr><td> 
 	<h2>This is the index page for <?php echo strtolower($template->title); ?></h2>
 	<?php if(count($template->orders) > 1): ?>
 	<ul>
    	<?php foreach ($template->orders as $model): ?>
    	<li>
			<a href="orders/<?php echo $model->model_id; ?>">
 	...
 	<ul>
 		<li>
 			<a href="orders/<?php echo $template->orders->model_id; ?>">
 					<?php echo $template->orders->model_name; ?> 
 			</a>
 		</li>
 	</ul>
 	<?php else: ?>
